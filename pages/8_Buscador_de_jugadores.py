...
if archivo and os.path.exists(archivo):
    ...
    st.markdown("### 📈 Distribución de minutos jugados")
    st.dataframe(df['Minutes played'].describe(), use_container_width=True)
    ...
    df_ref_filtrado = df_original[df_original['Minutes played'].notna() & (df_original['Minutes played'] >= min_minutos_ref)]
    ...
    with col3:
        ...
        df = df[df['Minutes played'].notna() & (df['Minutes played'] >= min_minutos)]
